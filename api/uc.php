...
// setCookie('username', 123, time()+3600, '/');exit();

//note 普通的 http 通知方式
if(!defined('IN_UC')) {
	
	// setCookie('username', 3, time()+3600, '/');
	...
	if(in_array($get['action'], array('test', 'deleteuser', 'renameuser', 'gettag', 'synlogin', 'synlogout', 'updatepw', 'updatebadwords', 'updatehosts', 'updateapps', 'updateclient', 'updatecredit', 'getcreditsettings', 'updatecreditsettings'))) {
		...
		// file_put_contents('uc.txt', $get['action']);
...
class uc_note {
	...
	function synlogin($get, $post) {
		...
		// file_put_contents('uc.txt', $uid.$username);
		$result['id'] = $uid;
		$result['user_nickname'] = $username;
